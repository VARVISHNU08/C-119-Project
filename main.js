...
function draw(){
  ...
  if(drawnSketch == sketch){
      answerHolder = "set";
      score++;
      document.getElementById("spnScore").innerHTML = "Score: " + score;
  }
...
function gotResult(error, results){
    ...
    document.getElementById("label").innerHTML = drawnSketch;
    document.getElementById("confidence").innerHTML = accuracy + "%";
}

function checkSketch(){
    timerCounter++;
    document.getElementById("spnTimer").innerHTML = "Timer: " + timerCounter;
